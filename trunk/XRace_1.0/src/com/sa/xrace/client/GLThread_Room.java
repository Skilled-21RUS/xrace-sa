...
public class GLThread_Room extends Thread {
	...
	GLThread_Room(GameActivity activity,SurfaceHolder mHolder,GameView inputView,RoomPicPool picPool,
		...
		picPool.loading = mActivity.getImageReadyfor(R.drawable.laod);
	...
	public static void makeLoading(GL10 gl,int numTime,int imgIndex) {
